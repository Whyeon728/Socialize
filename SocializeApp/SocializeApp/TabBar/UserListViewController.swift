...
//            }
            if (self.filteredUsers[indexPath.row].imageUrl != nil) {
                let url = URL(string: self.filteredUsers[indexPath.row].imageUrl!)
                cell.userListImageView.kf.setImage(with: url)
            } else {
                cell.userListImageView.image = UIImage(named: "default-profile-image")
            }
        } else {
...
//                cell.userListImageView.image = UIImage(named: "default-profile-image")
//            }
            if (self.users[indexPath.row].imageUrl != nil) {
